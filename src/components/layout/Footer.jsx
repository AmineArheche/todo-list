      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 dark:text-slate-400">
          ...
          <div className="flex flex-wrap items-center gap-2 text-center sm:text-left">
            ...
            <span>•</span>
            <span>
              Conçu avec <Heart className="inline w-3.5 h-3.5 text-rose-500 fill-rose-500 mx-0.5" /> par{' '}
              <a
                href="https://github.com/AmineArheche"
                target="_blank"
                rel="noopener noreferrer"
                className="font-bold text-slate-800 dark:text-slate-200 hover:text-brand-600 dark:hover:text-brand-400 underline decoration-brand-500/50 hover:decoration-brand-500 transition-colors"
                title="Visiter mon profil GitHub @AmineArheche"
              >
                Amine Arheche
              </a>
            </span>
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 hover:text-brand-600 dark:hover:text-brand-400 transition-colors font-semibold cursor-pointer"
              title="Voir mon profil GitHub (Amine Arheche)"
            >
              ...
              <span>GitHub @AmineArheche</span>
            </a>

            {/* Back to top button */}
            <button
              onClick={scrollToTop}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-brand-50 hover:text-brand-600 dark:hover:bg-brand-950/60 dark:hover:text-brand-400 text-slate-700 dark:text-slate-300 transition-all font-medium cursor-pointer group"
